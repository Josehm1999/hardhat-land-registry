...
!developmentChains.includes(network.name)
    ...
    : describe('Title Registry Unit Tests', function() {
        ...
        describe('registerTitle', function() {
            it('Solo el usuario Admin puede registrar nuevas propiedades'),
                async function() {
            ...
            it('Emite un evento despues de registrar una propiedad', async function() {
                expect(
